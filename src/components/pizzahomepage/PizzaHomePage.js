                ...
                <Navbar bg="danger" variant="dark">
                    <Navbar.Brand href="/"><Image height='80px' src="https://www.fasteat.xyz/upload/1559006953-best-italian-pizza-icon-sticker-1542410429.1995544.png"></Image></Navbar.Brand>
                        <Nav className="mr-auto">
                            <Link to="/Menu" style={{marginTop:"10px"}}><Button style={{ marginLeft:'120px',marginBottom:'2%',marginTop:'3%',width:'300px',display:'inline-block',verticalAlign:"-12px"}} variant="dark">Menu</Button></Link>
                            <Link to="/Orders" style={{marginTop:"10px"}}><Button style={{ marginLeft:'120px',marginBottom:'2%',marginTop:'3%',width:'300px',display:'inline-block',verticalAlign:"-12px"}} variant="dark">Orders</Button></Link>
                            <Link to="/ContectUs" style={{marginTop:"10px"}}><Button style={{ marginLeft:'120px',marginBottom:'2%',marginTop:'3%',width:'300px',display:'inline-block',verticalAlign:"-12px"}} variant="dark">Connect Us</Button></Link>
